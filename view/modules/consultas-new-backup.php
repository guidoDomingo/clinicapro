...
<body class="consultas-app consultas-page" data-user-id="<?php echo $userId; ?>">
        ...
        <main id="main-content" class="main-content" style="display: none;">
            ...
            <section class="form-type-selector">
                <div class="form-type-tabs" id="form-type-tabs">
                    <button class="form-type-tab active" data-form-type="general" wire:click="changeFormType('general')">
                        <i class="fas fa-notes-medical"></i>
                        <span>General</span>
                    </button>
                    <button class="form-type-tab" data-form-type="anteojos" wire:click="changeFormType('anteojos')">
                        <i class="fas fa-glasses"></i>
                        <span>Anteojos</span>
                    </button>
                    <button class="form-type-tab" data-form-type="estudios" wire:click="changeFormType('estudios')">
                        <i class="fas fa-x-ray"></i>
                        <span>Estudios</span>
                    </button>
                    <button class="form-type-tab" data-form-type="informe_imagen" wire:click="changeFormType('informe_imagen')">
            ...
            <section class="patient-info-panel">
                <div class="patient-search">
                    <div class="form-group patient-search-container">
                        ...
                        <input type="text" id="txtdocumento" class="form-control" wire:model="search_documento" wire:change="searchPatients" placeholder="Número de documento">
                    </div>
                    <div class="form-group patient-search-container">
                        <label for="txtficha">Ficha</label>
                        <input type="text" id="txtficha" class="form-control" wire:model="search_ficha" wire:change="searchPatients" placeholder="Número de ficha">
                    </div>
                    <div class="form-group patient-search-container">
                        <label for="paciente">Nombre</label>
                        <input type="text" id="paciente" class="form-control" wire:model="search_nombre" wire:change="searchPatients" placeholder="Nombre del paciente">
                    </div>
                ...
                <div class="patient-info-display" id="patient-info-display" wire:if="currentPatient">
                    <div class="patient-details">
                        <h5 id="profile-username" wire:text="currentPatient.nombre + ' ' + currentPatient.apellido">Seleccione un paciente</h5>
                        <p id="profile-ci" wire:text="'Doc: ' + currentPatient.documento">Para comenzar una consulta</p>
                    </div>
            ...
            <div class="tab-content" id="main-tab-content">
                ...
                <div class="tab-pane fade show active" id="consulta-panel" role="tabpanel">
                    ...
                    <div class="form-actions" style="margin-top: 30px; padding-top: 20px; border-top: 2px solid #f0f0f0;">
                        <button id="btnGuardarConsulta" class="btn-enhanced btn-success" type="button" wire:click="save" wire:loading.attr="disabled">
                            <span wire:loading.remove><i class="fas fa-save"></i> Guardar Consulta</span>
                            <span wire:loading><i class="fas fa-spinner fa-spin"></i> Guardando...</span>
                        </button>
                        <button id="btnLimpiarFormulario" class="btn-enhanced btn-warning" type="button" wire:click="reset">
                            <i class="fas fa-broom"></i> Limpiar Formulario
                        </button>
                        <button id="btnDescargarPDF" class="btn-enhanced btn-info" type="button" wire:if="currentModel" wire:click="downloadPDF">
                            <i class="fas fa-file-pdf"></i> Descargar PDF
                        </button>
                        <button id="btnEnviarWhatsApp" class="btn-enhanced btn-success" type="button" wire:if="currentModel && whatsapptxt" wire:click="sendWhatsApp">
    ...
    <script>
        // Cargar scripts del sistema Livewire CRUD
        const scriptsToLoad = [
        ...
        const loadScript = (src) => {
            return new Promise((resolve, reject) => {
                ...
                script.src = src;
                script.onload = () => {
                    console.log('✅ Script Livewire cargado:', src);
                    resolve();
                };
                script.onerror = () => {
                    console.error('❌ Error cargando script Livewire:', src);
        ...
        (async () => {
            try {
                ...
                console.log('🎉 Sistema Livewire CRUD cargado correctamente');
                
                // Notificar que los scripts están listos
                window.dispatchEvent(new CustomEvent('livewireScriptsLoaded'));
                
            } catch (error) {
                console.error('❌ Error cargando sistema Livewire:', error);
            }
        })();
    </script>
    ...
    <script>
        ...
        const initializeLivewireSystem = async () => {
            ...
            try {
                ...
                window.cambiarFormulario = window.livewireAPI.cambiarFormulario;
                window.guardarConsultaLivwire = window.livewireAPI.guardarConsulta;
                }
                
                console.log('🎉 Sistema Livewire CRUD inicializado correctamente');
                ...
                if (window.APP_CONFIG.debug) {
                    ...
                    console.log('🔧 API Livewire disponible en window.livwireAPI');
                }
        ...
        if (window.APP_CONFIG.debug) {
            window.debugLivwire = {
                getCRUD: () => livwireCRUD,
                getForms: () => formIntegrator,
                getState: () => livwireCRUD?.state,
                ...
                testSave: () => window.livwireAPI.guardarConsulta(),
                testFormChange: (type) => window.livwireAPI.cambiarFormulario(type),
                version: () => window.APP_CONFIG.version
            };
            
            console.log('🔧 Debug tools Livwire disponibles en window.debugLivwire');
            console.log('💡 Ejemplos: debugLivwire.getState(), debugLivwire.testFormChange("anteojos")');
        }
