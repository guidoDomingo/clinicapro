...
window.APP_CONFIG = window.APP_CONFIG || {
    ...
    userName: 'Usuario',
    endpoints: {
        livwireCrud: '/clinica/modules/consultas/api/livwire-crud.php'
    }
};ión simple para el sistema de consultas
console.log('🚀 Iniciando sistema de consultas simplificado...');
...
window.APP_CONFIG = {
    version: '2.1.0-Simple',
    debug: true,
    userId: <?php echo (int)($userId ?? 1); ?>,
    userName: '<?php echo htmlspecialchars($userName ?? 'Usuario'); ?>',
    endpoints: {
        livewireCrud: '/clinica/modules/consultas/api/livwire-crud.php'
    }
};
